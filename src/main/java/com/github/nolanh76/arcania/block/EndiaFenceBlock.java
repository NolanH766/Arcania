...
public class EndiaFenceBlock extends ArcaniaModElements.ModElement {
	@ObjectHolder("arcania:endia_fence")
	public static final Block block = null;
	public EndiaFenceBlock(ArcaniaModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends FenceBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EndiaFenceBlock.block, (int) (1)));
		}
	}
}
