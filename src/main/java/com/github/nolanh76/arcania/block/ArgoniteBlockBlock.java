...
public class ArgoniteBlockBlock extends ArcaniaModElements.ModElement {
	@ObjectHolder("arcania:argonite_block")
	public static final Block block = null;
	public ArgoniteBlockBlock(ArcaniaModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("argonite_block");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ArgoniteBlockBlock.block, (int) (1)));
		}
	}
}
