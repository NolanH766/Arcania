...
public class ChiseledEumusBricksBlock extends ArcaniaModElements.ModElement {
	@ObjectHolder("arcania:chiseled_eumus_bricks")
	public static final Block block = null;
	public ChiseledEumusBricksBlock(ArcaniaModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_eumus_bricks");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ChiseledEumusBricksBlock.block, (int) (1)));
		}
	}
}
