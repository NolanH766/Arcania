...
import com.github.nolanh76.arcania.procedures.PoisounousFluidMobplayerCollidesBlockProcedure;
import com.github.nolanh76.arcania.ArcaniaModElements;

@ArcaniaModElements.ModElement.Tag
public class PoisounousFluidBlock extends ArcaniaModElements.ModElement {
	@ObjectHolder("arcania:poisounous_fluid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("arcania:poisounous_fluid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public PoisounousFluidBlock(ArcaniaModElements instance) {
		super(instance, 9);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("arcania:blocks/poisounous_fluid_still"), new ResourceLocation("arcania:blocks/poisounous_fluid_flow"))
				.luminosity(0).density(1000).viscosity(1000)).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("poisounous_fluid");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("poisounous_fluid_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER)) {
			...
			public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
				...
				int z = pos.getZ();
				{
					...
					PoisounousFluidMobplayerCollidesBlockProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("poisounous_fluid"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("poisounous_fluid_bucket"));
	}
