...
public class EndiaTrapdoorBlock extends ArcaniaModElements.ModElement {
	@ObjectHolder("arcania:endia_trapdoor")
	public static final Block block = null;
	public EndiaTrapdoorBlock(ArcaniaModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("endia_trapdoor");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EndiaTrapdoorBlock.block, (int) (1)));
		}
	}
}
