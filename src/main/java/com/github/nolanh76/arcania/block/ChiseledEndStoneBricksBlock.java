...
public class ChiseledEndStoneBricksBlock extends ArcaniaModElements.ModElement {
	@ObjectHolder("arcania:chiseled_end_stone_bricks")
	public static final Block block = null;
	public ChiseledEndStoneBricksBlock(ArcaniaModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_end_stone_bricks");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ChiseledEndStoneBricksBlock.block, (int) (1)));
		}
	}
}
