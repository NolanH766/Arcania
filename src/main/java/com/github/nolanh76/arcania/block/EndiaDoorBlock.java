...
public class EndiaDoorBlock extends ArcaniaModElements.ModElement {
	@ObjectHolder("arcania:endia_door")
	public static final Block block = null;
	public EndiaDoorBlock(ArcaniaModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends DoorBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EndiaDoorBlock.block, (int) (1)));
		}
	}
}
