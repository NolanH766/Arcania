...
public class EndiaPlanksBlock extends ArcaniaModElements.ModElement {
	@ObjectHolder("arcania:endia_planks")
	public static final Block block = null;
	public EndiaPlanksBlock(ArcaniaModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EndiaPlanksBlock.block, (int) (1)));
		}
	}
}
